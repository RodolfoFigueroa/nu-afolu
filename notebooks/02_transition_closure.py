...
def _():
    ...
    return chen_artifact_dir, out_path
                ...
                [
                    {
                        ...
                        "zones": df_calibration["zone"].nunique(),
                        "scenarios": df_calibration["scenario"].nunique(),
                    }
                ]
            ),
        ]
...
def _(
    ...
    _artifacts = {
        ...
        "review_candidates": (
            df_review_candidates,
            chen_artifact_dir / "review_candidates.parquet",
        ),
    }
